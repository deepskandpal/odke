...
- **Records.** A `structured` document from `odke.loaders` carries its row and
...
from odke._text import iter_lines, trim
...
from odke.loaders.text import markdown_headings
from odke.ontology import Ontology, Predicate
from odke.types import Chunk, Fact
