...
from openodke.loaders.base import MissingExtraError, MissingExtraWarning
...
from openodke.loaders.structured import CsvLoader, JsonlLoader, JsonLoader, ParquetLoader, TsvLoader
from openodke.loaders.text import MarkdownLoader, TextLoader
from openodke.stages import Loader, Source
...
class DirectoryLoader:
    ...
    `openodke[pdf]` — is skipped with a `MissingExtraWarning` naming the file and
