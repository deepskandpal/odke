...
built for it. YAML, when PyYAML is installed (`openodke[yaml]`), opens with a header
...
from openodke.infer.build import EvidenceRef, Inference
...
def render(
    ...
    *,
    ...
    try:
        ...
        raise ImportError(
            'writing YAML needs PyYAML. Run: pip install "openodke[yaml]" — or write .json'
        ) from exc
