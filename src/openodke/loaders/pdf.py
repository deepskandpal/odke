...
`openodke.loaders.sourcemap`) records which page each run of the text came from and
...
Needs `pip install "openodke[pdf]"`; pypdf is imported when a file is read.
"""
...
from openodke.loaders.sourcemap import SourceMapBuilder
