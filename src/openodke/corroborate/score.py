...
from openodke.corroborate.merge import SourceKey, independent_sources, source_of
from openodke.corroborate.provenance import CONFLICT, SCORE, unstamped
...
class EvidenceScorer:
    ...
    **Picking a threshold.** Measure it. `openodke.eval` (#57) reports Brier score and
