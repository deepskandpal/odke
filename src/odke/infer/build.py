...
from odke.infer.merge import MergeDecision, merge
from odke.infer.names import fold
...
from odke.ontology import _JSON_TYPES, EntityType, Ontology, Predicate
from odke.types import Document, Span
...
class OntologyInferrer:
    """The `Inferrer` stage (`odke.stages`): a corpus in, an ontology to review out.
