...
separate path, `openodke.infer`, that produces one of these objects marked
...
from openodke.ontology.diff import SchemaChange
from openodke.ontology.diff import diff as schema_diff
from openodke.ontology.from_models import ontology_from_models
from openodke.ontology.from_neo4j import ontology_from_neo4j
from openodke.ontology.from_owl import ontology_from_owl
from openodke.ontology.load import (
...
from openodke.ontology.validate import Diagnostic, diagnose
...
class Ontology(BaseModel):
    ...
    def from_neo4j(
        ...
        *,
        ...
        See `openodke.ontology.from_neo4j` for what the store cannot say.
        """
    ...
    def infer(
        ...
        *,
        ...
        `openodke.infer.infer_ontology`, which this returns the ontology of.
        """
        from openodke.infer.build import infer_ontology
        from openodke.infer.sample import DEFAULT_SAMPLE_WORDS
