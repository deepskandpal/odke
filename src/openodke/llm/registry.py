...
from openodke.llm.base import LLMClient, ModelSpec, ProviderNotInstalled
...
def resolve(spec: ModelSpec) -> LLMClient:
    ...
    try:
        ...
        raise ProviderNotInstalled(
            ...
            f'  pip install "openodke[llm]"                     (adds ~100 providers)\n'
            f"  ModelSpec(model=..., base_url=...)          (any OpenAI-compatible endpoint)\n"
            f"  openodke.llm.register({provider!r}, my_factory)  (your own adapter)"
        ) from exc
