...
`openodke.llm.resolve` picks for the `infer` role.
"""
...
from openodke.infer.names import fold, predicate_name, type_name
from openodke.infer.sample import CorpusSample, words_in
