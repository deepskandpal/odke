...
Wrap a real client in `RecordingClient`, run the code once, and save::
    ...
    from openodke.llm import ModelSpec, resolve
    from openodke.llm.testing import RecordingClient
...
from openodke.llm.base import Completion, LLMClient, Message, ModelSpec, ProviderError
        ...
        *,
        ...
        if recorded is None:
            raise ProviderError(
                ...
                "cassette — see openodke.llm.testing."
            )
        return Completion(
            text=recorded.text,
